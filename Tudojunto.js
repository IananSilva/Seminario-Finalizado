...
class Aluno extends Pessoa {
    ...
    aviso() {
        alert(`${this.nome} Você entrou na seleção de cursos. Selecione o curso desejado.`);
    }
...
try {
    ...
    alert(`Erro ao mostrar informações do aluno: ${error.message}`);
}
...
try {
    ...
    alert(`Erro ao mostrar informações do professor: ${error.message}`);
}
...
try {
    ...
    alert(`Erro ao mostrar informações da turma: ${error.message}`);
}